...
# Installation
The EMLN package requires R version 4.1.0 and up, and depends on several packages. 
The package is installed directly from CRAN. Run this code to install and load it:
