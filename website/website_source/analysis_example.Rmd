...
```{r plotting_eigenvector_comparison,echo=TRUE, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE}
...
```{r plotting_Module_persistence,echo=TRUE, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE}
# Module' persistence
...
```{r plotting_Species_flow,echo=TRUE, eval=TRUE, include=TRUE, message=FALSE, warning=FALSE}
